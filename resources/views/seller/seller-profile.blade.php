      ...
      <div class="md:w-6/12 w-full flex flex-col justify-center items-start h-full md:px-10 px-5 py-3 md:py-0 ">
        ...
        <form action="" method="post" class="m-0 p-0 w-full" enctype="multipart/form-data">
          ...
          <div class="flex justify-end items-center w-full mt-6">
            ...
            <div class="flex">
              {{-- <a class="text-sm font-medium px-5 py-2 border border-primbuttn rounded text-primbuttn mr-3 " href="">Cancel</a>
              <button class="text-sm font-medium px-5 py-2 border bg-primbuttn rounded text-secondary " type="submit">Update</button> --}}
              <a class="text-sm font-medium px-5 py-2 border border-primbuttn rounded text-primbuttn" href="{{ route('seller.edit', $seller ) }}">Edit Profile</a>
            </div>
          </div>
        </form>
      </div>
